...
namespace SAP.DAL.DbContext.SAP
{
    public class ApplicationRoleManager : RoleManager<ApplicationRole>
    {
        ...
        {
            return new ApplicationRoleManager(new RoleStore<ApplicationRole>(context.Get<SAPDbContext>()));
        }
        ...
        public void DeleteRole(SAPDbContext context, ApplicationUserManager userManager, string roleId)
        {
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        {
            SAPDbContext context = new SAPDbContext();
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser>(context.Get<SAPDbContext>()));
